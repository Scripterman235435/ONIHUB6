...
MainSection:NewButton("Project Slayers(KEY)", "OP GUI", function()
...
MainSection:NewButton("ClickerMadness", "OP GUI", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/sxnsiferous/projectomega/main/ProjectOmega.lua"))()
end)


MainSection:NewButton("JailBreak", "OP GUI", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/KuriWasTaken/MonkeyScripts/main/JailMonkey.lua"))() 
end)


MainSection:NewButton("GrandPieceOnline(Key)", "OP GUI", function()
    loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/955dd3e8f43767eedf49f84ffac60170.lua"))()
end)


MainSection:NewButton("Pet Sim X", "OP GUI", function()
